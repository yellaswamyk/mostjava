...
public class SPMFTextEditor implements ActionListener {
	...
	public SPMFTextEditor(boolean runAsStandalone) {
        ...
        // Adjust the window position to make sure it is not outside the effective screen area
...
//		JFrame.setDefaultLookAndFeelDecorated(true);
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(SPMFTextEditor.class.getResource("/ca/pfv/spmf/gui/icons/History24.gif")));
		...
		// Save the preferences if the user want to run as a standalone application or not
...
//		TextLineNumber tln = new TextLineNumber(textAreaX, scrollPane, 3);
	...
	private java.awt.Rectangle getEffectiveScreenArea() {
        ...
        return new java.awt.Rectangle(minX, minY, (maxX - minX) / screenDevices, 
