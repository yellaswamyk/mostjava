...
public class DescriptionAlgoCGSPANMNI extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // set the minimum MNI threshold
        int minMNI = getParamAsInteger(parameters[0]);
        ...
        algo.runAlgorithm(inputFile, outputFile, minMNI, outputSingleFrequentVertices,
    ...
    public DescriptionOfParameter[] getParametersDescription() {
        ...
        parameters[0] = new DescriptionOfParameter("MinMNI", "(e.g. 2)", Integer.class, false);
