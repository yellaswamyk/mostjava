 ...
 */
public class DescriptionAlgoPOERMH extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoPOERMH(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Head_POERM_episode_rules.php";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoPOERMHeadFrequency algorithm = new AlgoPOERMHeadFrequency();
		algorithm.runAlgorithm(inputFile, minSupport, xSpan, ySpan, minConfidence, xySpan, selftIncrement);
		algorithm.writeRule2File(outputFile);
	}
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[0] = new DescriptionOfParameter("Minimum Support", "(e.g. 3)", Integer.class, false);
		...
		parameters[4] = new DescriptionOfParameter("Winlen?", "(e.g. 4", Integer.class, false);
