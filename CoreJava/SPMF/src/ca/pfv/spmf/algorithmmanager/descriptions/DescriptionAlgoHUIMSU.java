...
/**
 * This class describes the HUIMSU algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoHUIMiner
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoHUIMSU extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoHUIMSU(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/HUIM-SU_speedminer.php";
	}
