...
/**
 * This class describes the HUCI_Miner_Closed algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoFHIM_and_HUCI
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoHUCI_Miner_Closed extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoHUCI_Miner_Closed(){
	}

	@Override
	public String getName() {
		return "HUCI_Miner_Closed";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		algo.setDontOutputGeneratorItemsets(true);
	...
	public String[] getOutputFileTypes() {
		return new String[]{"Patterns",  "High-utility patterns","Closed itemsets","High-utility itemsets","Closed high-utility itemsets"};
	}
